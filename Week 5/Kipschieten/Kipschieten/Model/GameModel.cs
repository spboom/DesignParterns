...
namespace Kipschieten.Model
{
    public abstract class GameModel
    {
        ...
        public List<HashSet<GameModel>> DataStructures { get; private set; }

        public static Spawner<GameModel> spawner;
        ...
        public GameModel(Game game, int size)
        {
            DataStructures = new List<HashSet<GameModel>>();
            Field = game.field; ;
            Size = size;
            Center = new Coordinate(0, 0);
        }

        public GameModel(Game game, int size, int xPos, int yPos, bool collides, bool colidable, int xSpeed = 0, int ySpeed = 0)
            : this(game, size)
        {
        ...
        public static bool isColliding(GameModel object1, GameModel object2)
        {
        ...
        public void setDataStructures(List<HashSet<GameModel>> dataStructures)
        {
            removeDataStructures();
        ...
        public static bool isHit(Coordinate coordinate, GameModel gameObject)
        {
